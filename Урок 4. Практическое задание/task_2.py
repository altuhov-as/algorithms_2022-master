...
num_100000 = randint(100000000000, 10000000000000000)
...
"""
добавил свое число и вывод результатов замера. Мемоизация помогает, но стоит словарь в мемоизации заменить на список.
"""